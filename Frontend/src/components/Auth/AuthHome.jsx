...
{/* Inserted ComplaintFilter after hero */}
<ComplaintFilter />
<MapView />
...
<section className="py-16" style={{ background: "#ffffff" }}>
  <div className="container mx-auto px-12">
    <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Common Complaint Categories</h2>
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
      <Link to="/complaint">  
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faTint} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Water Issues</h3>
          <p className="text-sm text-gray-600">Leakages, shortages, quality</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faBolt} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Electricity</h3>
          <p className="text-sm text-gray-600">Outages, safety hazards</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faRoad} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Road Damages</h3>
          <p className="text-sm text-gray-600">Potholes, traffic issues</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faTrash} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Garbage Disposal</h3>
          <p className="text-sm text-gray-600">Collection, dumping sites</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faTree} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Parks & Green Areas</h3>
          <p className="text-sm text-gray-600">Maintenance, facilities</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faBus} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Public Transport</h3>
          <p className="text-sm text-gray-600">Services, facilities, fares</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          <div className="bg-gray-200 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
            <FontAwesomeIcon icon={faBuildingIcon} className="text-gray-600 text-xl" />
          </div>
          <h3 className="font-semibold mb-2">Public Buildings</h3>
          <p className="text-sm text-gray-600">Maintenance, accessibility</p>
        </div>
      </Link>
      <Link to="/complaint">
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer text-center">
          ...
          <h3 className="font-semibold mb-2">Other Issues</h3>
          <p className="text-sm text-gray-600">Not listed above</p>
        </div>
      </Link>
    </div>
  </div>
